...
export ENVNAME=howelld
export APPNAME=howelld
export $(echo $ENVNAME)$(echo "_HOME")=/plotting/howelldata
...
$APPNAME init test 
wget -O $howelld_HOME/config/genesis.json https://ipfs.io/ipfs/$GENESIS
